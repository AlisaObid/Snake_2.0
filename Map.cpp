...
void Map::hod(std::int16_t x, std::int16_t y) //изменение змейки и €блока
{
	...
	//for (int i = 0; i < mSnake.getSize() + 1; i++)
	//{
	...
	//		if (b[q][w] > mSnake.getSize()) //мы на последней €чейке змейки?
	//		{
